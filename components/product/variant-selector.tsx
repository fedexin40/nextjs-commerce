        ...
        {option.values.map((value) => {
          ...
          return (
            <DynamicTag
              ...
              className={clsx(
                'flex h-8 min-w-[38px] items-center justify-center rounded px-2 text-xs',
                {
                  'cursor-default ring-2 ring-gray-400 dark:ring-white': isActive,
                  'ring-1 ring-gray-300 transition duration-300 ease-in-out hover:scale-110 hover:bg-gray-100 hover:ring-gray-400 dark:ring-gray-700 dark:hover:bg-transparent dark:hover:ring-white':
