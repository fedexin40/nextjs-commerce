...
type Documents = {
  ...
  'query GetShippingMethods($id: ID!) {\n  checkout(id: $id) {\n    id\n    shippingMethods {\n      description\n      id\n      maximumDeliveryDays\n      name\n      price {\n        amount\n        currency\n      }\n    }\n  }\n}': typeof types.GetShippingMethodsDocument;
  'query LastCheckout {\n  me {\n    checkouts(first: 1) {\n      edges {\n        node {\n          id\n          metadata {\n            key\n            value\n          }\n        }\n      }\n    }\n  }\n}': typeof types.LastCheckoutDocument;
 ...
 */
export function graphql(
  source: 'mutation CheckoutRemovePromoCode($id: ID!, $promoCode: String!) {\n  checkoutRemovePromoCode(promoCode: $promoCode, id: $id) {\n    errors {\n      code\n      field\n      message\n    }\n  }\n}',
 ...
 */
export function graphql(
  source: 'mutation TransactionInitialize($checkoutId: ID!, $data: JSON!, $paymentGateway: String!) {\n  transactionInitialize(\n    id: $checkoutId\n    paymentGateway: {id: $paymentGateway, data: $data}\n  ) {\n    transaction {\n      id\n    }\n    transactionEvent {\n      id\n    }\n    data\n    errors {\n      field\n      message\n      code\n    }\n  }\n}',
 ...
 */
export function graphql(
  source: 'query GetCategoryProductsBySlug($slug: String!, $sortBy: ProductOrderField!, $sortDirection: OrderDirection!, $after: String!, $first: Int!) {\n  category(slug: $slug) {\n    products(\n      where: {stockAvailability: IN_STOCK}\n      channel: "proyecto705"\n      first: $first\n      after: $after\n      sortBy: {field: $sortBy, direction: $sortDirection}\n    ) {\n      pageInfo {\n        hasNextPage\n        endCursor\n        startCursor\n      }\n      totalCount\n      edges {\n        node {\n          id\n          slug\n          name\n          isAvailableForPurchase\n          description\n          seoTitle\n          seoDescription\n          category {\n            name\n            slug\n          }\n          pricing {\n            priceRange {\n              start {\n                gross {\n                  currency\n                  amount\n                }\n              }\n              stop {\n                gross {\n                  currency\n                  amount\n                }\n              }\n            }\n            discount {\n              gross {\n                amount\n                currency\n              }\n            }\n          }\n          media {\n            url(size: 2160)\n            type\n            alt\n          }\n          collections {\n            name\n            slug\n          }\n          updatedAt\n          variants {\n            ...Variant\n          }\n          metadata {\n            key\n            value\n          }\n          productType {\n            isShippingRequired\n          }\n        }\n      }\n    }\n  }\n}',
 ...
 */
export function graphql(
  source: 'query GetCollectionProductsBySlug($slug: String!, $sortBy: ProductOrderField!, $sortDirection: OrderDirection!, $after: String!, $first: Int!) {\n  collection(channel: "proyecto705", slug: $slug) {\n    products(\n      where: {stockAvailability: IN_STOCK}\n      after: $after\n      first: $first\n      sortBy: {field: $sortBy, direction: $sortDirection}\n    ) {\n      pageInfo {\n        hasNextPage\n        endCursor\n        startCursor\n      }\n      totalCount\n      edges {\n        node {\n          id\n          slug\n          name\n          isAvailableForPurchase\n          description\n          seoTitle\n          seoDescription\n          category {\n            name\n            slug\n          }\n          pricing {\n            priceRange {\n              start {\n                gross {\n                  currency\n                  amount\n                }\n              }\n              stop {\n                gross {\n                  currency\n                  amount\n                }\n              }\n            }\n            discount {\n              gross {\n                amount\n                currency\n              }\n            }\n          }\n          media {\n            url(size: 2160)\n            type\n            alt\n          }\n          collections {\n            name\n            slug\n          }\n          updatedAt\n          variants {\n            ...Variant\n          }\n          metadata {\n            key\n            value\n          }\n          productType {\n            isShippingRequired\n          }\n        }\n      }\n    }\n  }\n}',
 ...
 */
export function graphql(
  source: 'query OrdersByEmail($email: String!) {\n  orders(first: 1, where: {userEmail: {eq: $email}}) {\n    edges {\n      node {\n        id\n      }\n    }\n  }\n}',
): typeof import('./graphql').OrdersByEmailDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
 ...
 */
export function graphql(
  source: 'query SearchProducts($search: String!, $sortBy: ProductOrderField!, $sortDirection: OrderDirection!, $after: String!, $first: Int!) {\n  products(\n    channel: "proyecto705"\n    sortBy: {field: $sortBy, direction: $sortDirection}\n    filter: {search: $search}\n    after: $after\n    first: $first\n  ) {\n    pageInfo {\n      hasNextPage\n      endCursor\n      startCursor\n    }\n    totalCount\n    edges {\n      node {\n        id\n        slug\n        name\n        isAvailableForPurchase\n        description\n        seoTitle\n        seoDescription\n        category {\n          name\n          slug\n        }\n        pricing {\n          priceRange {\n            start {\n              gross {\n                currency\n                amount\n              }\n            }\n            stop {\n              gross {\n                currency\n                amount\n              }\n            }\n          }\n        }\n        media {\n          url(size: 2160)\n          type\n          alt\n        }\n        collections {\n          name\n          slug\n        }\n        updatedAt\n        variants {\n          ...Variant\n        }\n        metadata {\n          key\n          value\n        }\n        productType {\n          isShippingRequired\n        }\n      }\n    }\n  }\n}',
